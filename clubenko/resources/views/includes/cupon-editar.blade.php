@if($cupon->fecha_fin < $now)
	<a href="{!! route('editar_cupon', $cupon->slug) !!}"><div class="caducado"><p>OFERTA CADUCADA</p></div></a>
@endif
<div class="brand">
	@if($cupon->logo == 'logo')
...
<a href="{!! route('editar_cupon', $cupon->slug) !!}">
...
<div class="datos-cupon">
	<div class="tipo-descuento">
		...
		<p class="cupon-titulo"><a href="{!! route('editar_cupon', $cupon->slug) !!}">{!! $cupon->titulo !!}</a></p>
		<p class="cupon-descripcion"><a href="{!! route('editar_cupon', $cupon->slug) !!}">{!! $cupon->descripcion_corta !!}</a></p>
	</div>    	
</div>