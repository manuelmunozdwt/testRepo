@if($promocion->fecha_fin < $now)
	<a href="{!! route('editar_promocion', $promocion->slug) !!}"><div class="caducado"><p>OFERTA CADUCADA</p></div></a>
@endif
<div class="brand">
...
<a href="{!! route('editar_promocion', $promocion->slug) !!}">
...
<div class="datos-promocion">
	<div class="tipo-descuento">
		...
		<p class="promocion-titulo"><a href="{!! route('editar_promocion', $promocion->slug) !!}">{!! $promocion->titulo !!}</a></p>
		<p class="promocion-descripcion"><a href="{!! route('editar_promocion', $promocion->slug) !!}">{!! $promocion->descripcion_corta !!}</a></p>
	</div>    	
</div>