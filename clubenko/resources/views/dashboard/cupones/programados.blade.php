...
<div class="container">
                ...
                <div class="submenu-item-description">
                    <div class="listado hidden">
                        ...
                        <div class="iconos-listados">
                            ...
                            <div class="iconos"><a class="" href="{!! route('listar-cupones-programados', Auth::user()->slug) !!}"><img src="{!! asset('img/programados-W.png') !!}"><span class="activo">Programados</span></a></div>
                        </div>
                    </div>
    ...
    {{--@if(Auth::user()->cupon()->first() == '' || $data['cupones-programados']->first() == '')        
        <div class="row">
            <div class="col-md-12">
                <div class="blanco">
    ...
    @endif
    @foreach ($data['cupones-programados']->chunk(4) as $chunk)
        <div class="row gris">
            @foreach ($chunk as $cupon)
            <div class="col-md-3">
                <div class="promo">
                    <a href="{!! route('cupones.edit', $cupon->slug) !!}">
