...
--}}
        ...
        <div class="row botones-usuario">
            <a class="gris editar">Sugerimos que subas una imagen de 786px X 250px</a>
        </div>  
        ...
        {!! Form::open(['route' => 'banner_home_edit', 'files' => true, 'id' => 'form_banner_home']) !!}
        <div class="row">
