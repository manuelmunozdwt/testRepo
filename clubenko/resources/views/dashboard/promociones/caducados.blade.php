                ...
                <div class="submenu-item-description">
                    <div class="listado hidden">
                        ...
                        <div class="iconos-listados">
                            ...
                            <div class="iconos"><a class="" href="{!! route('listar-promociones-caducados', Auth::user()->slug) !!}"><img src="{!! asset('img/caducados-W.png') !!}"><span class='activo'>Caducadas</span></a></div>
                            <div class="iconos"><a class="" href="{!! route('listar-promociones-programados', Auth::user()->slug) !!}"><img src="{!! asset('img/programados.png') !!}"><span>Programadas</span></a></div>
                        </div>
                    </div>
