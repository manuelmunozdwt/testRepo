<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="visualizacion-promocion" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-4 texto-visualizacion-cupon">
                <p style="margin-top:50%">Así es como quedaría el promocion que has creado</p>
                <p>Recuerda que una vez creada y validada puedes volver a editarla en editar mis promociones</p>
            </div>
