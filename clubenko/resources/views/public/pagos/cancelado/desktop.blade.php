...
<section class="main">
  ...
  <div class="row head">
    ...
    <div id="mod-welcome" style="text-align: center;">
        <h1>Su pago no ha sido procesado correctamente</h1>
        <h2>Por favor, vuelva a realizar la compra. </h2>
    </div>
  ...
  <div class="row main">
    ...
    <div id="main" class="left columns twelve" style="min-height: 585px;">
      <div style="width: 150px;margin: auto; margin-top:20px">
        <img src="{{ asset('img/pagos/icono-check-rojo.png') }}" alt="">
      </div>

      <div style="text-align: center; margin-top:30px">
        Volver a al <a href="{{ route('home') }}">Inicio</a>
      </div>
